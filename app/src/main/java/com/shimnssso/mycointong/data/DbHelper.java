...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + DbMeta.CoinTableMeta.TABLE_NAME + " ("
                ...
                + DbMeta.CoinTableMeta.UNIT_TIME + " TEXT DEFAULT '" + Const.UnitTime.FIFTEEN_MIN + "'"
                + " )"
        );

        String[][] coinList = {
                {Const.Coin.BTC, Const.Currency.KRW, Const.Exchange.KORBIT, "1", "0", "https://coinone.co.kr/chart/?site=Korbit"},
                {Const.Coin.BTC, Const.Currency.KRW, Const.Exchange.BITHUMB, "1", "1", "https://cryptowat.ch/bithumb/btckrw"},
                {Const.Coin.BTC, Const.Currency.KRW, Const.Exchange.COINONE, "1", "2", "https://coinone.co.kr/chart/?site=Coinone"},
                {Const.Coin.BTC, Const.Currency.USD, Const.Exchange.BITFINEX, "1", "3", "https://cryptowat.ch/bitfinex/btcusd"},
                {Const.Coin.BTC, Const.Currency.CNY, Const.Exchange.OKCOIN, "1", "4", "https://cryptowat.ch/okcoin/btccny"},
                {Const.Coin.BTC, Const.Currency.JPY, Const.Exchange.BITFLYER, "1", "5", "https://cryptowat.ch/bitflyer/btcfxjpy"},
